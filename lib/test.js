...
async function testTafsir() {
    ...
    (0, assert_1.default)(answer.action === 'tafsir' && answer.data.chapter.id === 2);
    ...
    (0, assert_1.default)(answer.action === 'tafsir' && answer.data.verses.length === 1);
    ...
    (0, assert_1.default)(answer.action === 'tafsir' && answer.data.verses.length === 5);
...
async function testAudio() {
    ...
    (0, assert_1.default)(answer.action === 'audio' && answer.data.audios.length === 10);
    answer = await testQuestion('audio surat 1 ayat 1-3');
    (0, assert_1.default)(answer.action === 'audio' && answer.data.audios.length === 3);
    answer = await testQuestion('audio surat an naas');
    (0, assert_1.default)(answer.action === 'audio' && answer.data.audios.length > 1);
