...
async function getAnswer(resp, user) {
    ...
    if (((_c = (_b = answer.data) === null || _b === void 0 ? void 0 : _b.verses) === null || _c === void 0 ? void 0 : _c.length) > MAX_RESULT) {
        ...
        const lastVerse = (_g = (_d = answer === null || answer === void 0 ? void 0 : answer.data) === null || _d === void 0 ? void 0 : _d.verses[((_f = (_e = answer === null || answer === void 0 ? void 0 : answer.data) === null || _e === void 0 ? void 0 : _e.verses) === null || _f === void 0 ? void 0 : _f.length) - 1]) === null || _g === void 0 ? void 0 : _g.id;
        if (lastVerse && lastVerse + 1 >= meta.verses.length) {
            ...
            records.set(user, {
                action: (rec === null || rec === void 0 ? void 0 : rec.action) || answer.action,
                source: (rec === null || rec === void 0 ? void 0 : rec.source) || answer.source,
                verses: [],
                lastVerse,
            });
        }
    ...
    // ga ada ayat
    if (!((_j = (_h = answer.data) === null || _h === void 0 ? void 0 : _h.verses) === null || _j === void 0 ? void 0 : _j.length)) {
...
function getNextAnswer(user) {
    ...
    if ((_a = last.verses) === null || _a === void 0 ? void 0 : _a.length)
    ...
    const answer = (0, verse_1.getVersesByIds)([lastVerse]);
    answer.action = 'next';
    answer.data.next = true;
    return answer;
}
