...
exports.getAnswer = exports.getCache = void 0;
...
async function getAnswer(resp, user = 'UNKNOWN', platform = 'web') {
    var _a, _b, _c, _d;
    ...
    // ada entity keyword search
        ...
        answer = await (0, search_1.getSearchAnswer)(resp);
    }
    ...
    if (((_b = (_a = answer.data) === null || _a === void 0 ? void 0 : _a.verses) === null || _b === void 0 ? void 0 : _b.length) > 10) {
    ...
    // ga ada ayat
    if (!((_d = (_c = answer.data) === null || _c === void 0 ? void 0 : _c.verses) === null || _d === void 0 ? void 0 : _d.length)) {
...
function getEntityAnswer(entities) {
    var _a;
